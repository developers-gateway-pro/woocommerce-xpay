<?php
/*
 * Plugin Name: Xpay Payment Gateway For WooCommerce
...
function pagoseguro_init_gateway_class()
{
    ...
    class PagoSeguro_Gateway extends WC_Payment_Gateway
    {
        ...
        public function __construct()
        {
            ...
            $this->method_title       = __('Xpay', 'pagoseguro');
            $this->method_description = __('Xpay Payment Checkout', 'pagoseguro'); // will be displayed on the options page
        ...
        public function admin_options()
        {
            if ($this->isValidForUse()) {
                ...
                $icon = 'https://img-app-v1.s3.amazonaws.com/img_dashboard/xpay_claro_fondo_b.png';
        ...
        */
        ...
        /*
        * Validate order and Redirect Xpay
        */
